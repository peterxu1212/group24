...
class CNNv10(nn.Module):
    def __init__(self):
        super(CNNv10, self).__init__()
         
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=32, kernel_size=5, stride=1, padding=0), #W1 = 60
            #nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(in_channels=32, out_channels=96, kernel_size=3, stride=1, padding=1), #W2 = 60
            #nn.BatchNorm2d(48),
            nn.ReLU(),
            nn.Conv2d(in_channels=96, out_channels=192, kernel_size=2, stride=1, padding=0), #W2 = 59
            #nn.BatchNorm2d(144),
            nn.ReLU(),
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=192, out_channels=192, kernel_size=3, stride=1, padding=1), #W4 = 29
            nn.BatchNorm2d(192),
            nn.ReLU(),
            nn.Conv2d(in_channels=192, out_channels=384, kernel_size=3, stride=1, padding=1), #W5 = 29
            nn.BatchNorm2d(384),
            nn.ReLU(),
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=384, out_channels=384, kernel_size=3, stride=1, padding=1),  #W7 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=384, out_channels=384, kernel_size=3, stride=1, padding=1),  #W8 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=384, out_channels=384, kernel_size=3, stride=1, padding=1),  #W10 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=384, out_channels=384, kernel_size=3, stride=1, padding=1),  #W11 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(in_channels=768, out_channels=768, kernel_size=3, stride=1, padding=1),  #W13 = 3
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=768, out_channels=768, kernel_size=3, stride=1, padding=1),  #W14 = 3
            #nn.BatchNorm2d(512),            
            nn.ReLU(),                 # activation
...
class CNNv9(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=64, kernel_size=5, stride=1, padding=0), #W1 = 60
            #nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(in_channels=64, out_channels=256, kernel_size=3, stride=1, padding=1), #W2 = 60
            #nn.BatchNorm2d(48),
            nn.ReLU(),
            nn.Conv2d(in_channels=256, out_channels=1024, kernel_size=2, stride=1, padding=0), #W2 = 59
            #nn.BatchNorm2d(144),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2), #W3 = 29
        )
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=3, stride=1, padding=1), #W4 = 29
            nn.BatchNorm2d(1024),
            nn.ReLU(),
            nn.Conv2d(in_channels=1024, out_channels=2048, kernel_size=3, stride=1, padding=1), #W5 = 29
            nn.BatchNorm2d(2048),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2), #W6 = 14
        )
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W7 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W8 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W9 = 7
        )
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W10 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W11 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=3, stride=2),  # W12 = 3
        )
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W13 = 3
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=2048, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W14 = 3
            #nn.BatchNorm2d(512),            
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=3, stride=2),  # W15 = 1
        )
...
# try normalize for conv1, compared to v7
class CNNv8(nn.Module):
    def __init__(self):
        super(CNNv8, self).__init__()
         
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=16, kernel_size=5, stride=1, padding=0), #W1 = 60
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(in_channels=16, out_channels=64, kernel_size=3, stride=1, padding=1), #W2 = 60
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(in_channels=64, out_channels=256, kernel_size=2, stride=1, padding=0), #W2 = 59
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2), #W3 = 29
        )
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1), #W4 = 29
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1), #W5 = 29
            nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2), #W6 = 14
        )
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W7 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W8 = 14
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W9 = 7
        )
        ...
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W10 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W11 = 7
            #nn.BatchNorm2d(512),
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=3, stride=2),  # W12 = 3
        )
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W13 = 3
            #nn.BatchNorm2d(512),
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W14 = 3
            #nn.BatchNorm2d(512),            
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=3, stride=2),  # W15 = 1
        )
...
# around 97% for even raw input, without [<= 254] = 0
class CNNv7(nn.Module):
    def __init__(self):
        super(CNNv7, self).__init__()
...
# great which achieve 96.7% with < 254 = 0 input
class CNNv6(nn.Module):
    def __init__(self):
        super(CNNv6, self).__init__()
        ...
        """
        self.conv5 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=1024, kernel_size=3, stride=1, padding=1),  #W13 = 4
            nn.ReLU(),
            nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=3, stride=1, padding=1),  #W14 = 4
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W15 = 2
        )
...
class CNNv5(nn.Module):
    def __init__(self):
        super(CNNv5, self).__init__()
         
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=16, kernel_size=3, stride=1, padding=1), #W1 = 64
            nn.ReLU(),
            nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1, padding=1), #W2 = 64
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2), #W3 = 32
        )
        
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=16, out_channels=128, kernel_size=3, stride=1, padding=1), #W4 = 32
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1), #W5 = 32
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2), #W6 = 16
        )
        
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1),  #W7 = 16
            nn.ReLU(),
            nn.Conv2d(in_channels=256, out_channels=256, kernel_size=3, stride=1, padding=1),  #W8 = 16
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W9 = 8
        )
        
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1),  #W10 = 8
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W11 = 8
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W12 = 4
        )
...
class CNNv4(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=64, kernel_size=3, stride=1, padding=1), #W1 = 64
            nn.ReLU(),
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=3, stride=1, padding=1), #W2 = 64
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2), #W3 = 32
        )
        
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1), #W4 = 32
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=128, kernel_size=3, stride=1, padding=1), #W5 = 32
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2), #W6 = 16
...
class CNNv3(nn.Module):
    def __init__(self):
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W13 = 4
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=512, kernel_size=3, stride=1, padding=1),  #W14 = 4
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W15 = 2
        )
...
class CNNv1(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential( #W0 = 64
            nn.Conv2d(in_channels=1, out_channels=8, kernel_size=15, stride=1, padding=0), #W1 = 50
            nn.ReLU(),
            nn.Conv2d(in_channels=8, out_channels=64, kernel_size=2, stride=1, padding=0), #W2 = 49
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2), #W3 = 24
        )
        
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=3, stride=1, padding=1), #W4 = 24
            nn.ReLU(),
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=3, stride=1, padding=1), #W5 = 24
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=2, stride=2), #W6 = 12
        )
        
        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3, stride=1, padding=1),  #W7 = 12
            nn.ReLU(),
            nn.Conv2d(in_channels=512, out_channels=1024, kernel_size=3, stride=1, padding=1),  #W8 = 12
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W9 = 6
        )
        
        self.conv4 = nn.Sequential(
            nn.Conv2d(in_channels=1024, out_channels=2048, kernel_size=3, stride=1, padding=1),  #W7 = 6
            nn.ReLU(),
            nn.Conv2d(in_channels=2048, out_channels=4096, kernel_size=3, stride=1, padding=1),  #W8 = 6
            nn.ReLU(),                 # activation
            nn.MaxPool2d(kernel_size=2, stride=2),  # W9 = 3
        )
        
        self.classifier = nn.Sequential(
            nn.Dropout(p = 0.5),
            nn.Linear(4096 * 3 * 3, 1024),
            #nn.Linear(1152 * 3 * 3, 128),
            nn.ReLU(),
            nn.Dropout(p = 0.5),
            nn.Linear(1024, 10)
