...
#train = pd.read_csv(input_data_folder + 'train_w_tidy.csv')
train = pd.read_csv(input_data_folder + 'train.csv')

test = pd.read_csv(input_data_folder + 'test.csv')
...
pca = RandomizedPCA(n_components=100, random_state=32)
#pca = RandomizedPCA(n_components=90, random_state=32)
pca.fit(X_train)
